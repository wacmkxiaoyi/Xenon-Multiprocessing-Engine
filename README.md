...
**Update in 4.1: The MPI mode blocking calculation function acquire\_block is merged into the acquire function (block=True can be specified) as blocking (results are called through the mpi.get() function). Also add broadcast function.**
